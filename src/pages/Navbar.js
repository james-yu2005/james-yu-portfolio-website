  ...
  return (
    <nav className="p-4 relative">
      <div className="container mx-auto flex justify-between items-center flex-wrap" style={{ fontFamily: 'Roboto, sans-serif' }}>
        <div className="text-indigo-300 relative text-4xl w-fit block after:block after:content-[''] 
        ...
        <ul className="flex flex-col lg:flex-row lg:space-x-5">
          <li className="mb-4 lg:mb-0">
            <a href="#experience" className="text-sky-900 relative text-2xl lg:text-4xl w-fit block after:block after:content-[''] 
          ...
          <li className="mb-4 lg:mb-0">
            <a href="#projects" className="text-sky-900 relative text-2xl lg:text-4xl w-fit block after:block after:content-[''] 
            after:absolute after:h-[2.5px] after:bg-indigo-300 after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition 
            after:duration-300 after:origin-center">
              Projects
            </a>
          ...
          <li>
            <a href="#contact" className="text-sky-900 relative text-2xl lg:text-4xl w-fit block after:block after:content-[''] 
            after:absolute after:h-[2.5px] after:bg-indigo-300 after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition 
            after:duration-300 after:origin-center">
              Contact
            </a>
